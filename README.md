...
- InsightFace AI Recognition (512-D Embeddings): Ekstraksi fitur wajah 512-dimensi presisi tinggi dengan ambang batas sah minimum >= 50.0% Match.
- Proteksi Pasif & Aktif Anti-Spoofing (Anti-Foto HP / Replay Attack):
...
- Pengaturan Jam Masuk & Pulang (Format 24-Jam): Fleksibilitas menentukan rentang jam absensi sekolah.
